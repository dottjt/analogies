...
import { BrainGraph, createGraph } from './helpers/functions';
...
let normalBrain = createGraph("normalBrain");



// let thoughtBrain = BrainGraph("thoughtBrain", REDUX.thoughtBrain);
//     thoughtBrain.app.ticker.add(() => {
//       thoughtBrain = runAnimation(thoughtBrain);
//     });
